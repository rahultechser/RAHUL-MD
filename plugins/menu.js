...
const { System, isPrivate, isUrl, config, getBuffer } = require("../lib/");
...
System({
    ...
    if (MEDIA_DATA) {
        ...
        await message.client.sendMessage(message.jid, { text: menu, contextInfo: { externalAdReply: { title, body, thumbnailUrl: thumbnail, renderLargerThumbnail: true, mediaType: 1, mediaUrl: '', sourceUrl: "https://github.com/rahultechser/RAHUL-MD", showAdAttribution: true } } });
    } else {
